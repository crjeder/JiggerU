...
### Requirement: Manual bar management

**Reason**: The bar is owned exclusively by the robot. Manual curation is an artefact of the upstream fork and does not fit this deployment model.
**Migration**: Connect a CocktailBot HAL robot. Bar content is set automatically on robot sync.
