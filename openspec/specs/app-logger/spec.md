# Capability: app-logger

## Overview

A namespaced logging utility that provides consistent, environment-aware log output across the application. All modules should use this logger instead of raw `console` calls.
